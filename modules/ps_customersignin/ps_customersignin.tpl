<div class="user-info">
  ...
  {else}
    <a class="login" href="{$my_account_url}" rel="nofollow" title="{l s='Log in to your customer account' d='Shop.Theme.Customeraccount'}"><i class="fa fa-user" ></i>{l s='Sign in' d='Shop.Theme.Actions'}</a>
  {/if}
</div>
